...
class SewageRoot(BoxLayout):
    ...
    def _build_ui(self):
        ...
        dot_row = BoxLayout(orientation="horizontal", size_hint_y=None,
                            height=dp(36), spacing=dp(10))
        ...
        self.pump_btn = Button(
            ...
            markup=True,
            background_normal="",
            background_color=(1.0, 0.341, 0.133, 1),
            color=(1, 1, 1, 1),
            size_hint_y=None,
            height=dp(48),
            font_size=sp(14)
        ...
        self.angle_slider = Slider(min=0, max=90, value=0,
        ...
        slider_labels = BoxLayout(orientation="horizontal",
                                  size_hint_y=None, height=dp(20))
        slider_labels.add_widget(Label(text="0°", font_size=sp(12),
                                       color=(0.5, 0.5, 0.5, 1)))
        slider_labels.add_widget(Label(text="90°", font_size=sp(12),
    ...
    def _query_device_status(self):
        ...
        pump_msg = {"gw": {"msg_id": 1, "msg_no": 0, "gateway": GATEWAY_PUMP, "time": t},
                    "data": {"stat": 0}}
        self.mqtt_client.publish(PUB_PUMP, json.dumps(pump_msg, separators=(",", ":")))
        valve_msg = {"gw": {"msg_id": 1, "msg_no": 0, "gateway": GATEWAY_VALVE, "time": t},
                     "data": {"stat": 0}}
    ...
    def toggle_pump(self):
        ...
        if self.stir_status == 0:
            payload = {"gw": {"msg_id": 4, "msg_no": 0, "gateway": GATEWAY_PUMP, "time": t},
                       "data": {"stir1": 1}}
            self.stir_status = 1
        else:
            payload = {"gw": {"msg_id": 4, "msg_no": 0, "gateway": GATEWAY_PUMP, "time": t},
    ...
    def angle_drag(self, slider, value):
        ...
        Clock.schedule_once(lambda dt: setattr(
            self.angle_text, "text", f"当前角度：{self.temp_angle} °"), 0)
    ...
    def angle_send(self, slider, touch):
        ...
        t = time.strftime("%Y-%m-%d %H:%M:%S")
        payload = {"gw": {"msg_id": 4, "msg_no": 0, "gateway": GATEWAY_VALVE, "time": t},
                   "data": {"angle1": angle}}
...
class SewageApp(App):
    ...
    def _connect(self):
        try:
            ...
            Clock.schedule_once(
                lambda dt: self.root_widget._update_disconnected_ui(), 0)
