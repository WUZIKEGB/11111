...
Config.set('kivy', 'default_font', 'DroidSansFallback')  # 设置默认中文字体
...
# 注册安卓系统自带的中文字体，确保手机上显示正常
LabelBase.register(
    name="DroidSansFallback",
    fn_regular="/system/fonts/DroidSansFallback.ttf"  # 安卓通用中文字体路径
)
...
class SewageRoot(BoxLayout):
    ...
    def _build_ui(self):
        ...
        pump_title = Label(
            text="[b]🧰 潜水泵远程控制[/b]", markup=True, font_size=sp(15), color=(0.1, 0.1, 0.1, 1),
        ...
        self.pump_status = Label(
            text="水泵状态：待检测", font_size=sp(14), color=(0.46, 0.46, 0.46, 1),
        ...
        valve_title = Label(
            text="[b]⚙️ 调节阀角度控制[/b]", markup=True, font_size=sp(15), color=(0.1, 0.1, 0.1, 1),
            size_hint_y=None, height=dp(30), halign="left", valign="middle"
        )
        ...
        self.angle_text = Label(
            text="当前角度：0 °", font_size=sp(14), color=(0.1, 0.1, 0.1, 1),
            size_hint_y=None, height=dp(30), halign="left", valign="middle"
        )
        ...
        slider_labels.add_widget(Label(text="0°", font_size=sp(12), color=(0.5, 0.5, 0.5, 1)))
        slider_labels.add_widget(Label(text="90°", font_size=sp(12), color=(0.5, 0.5, 0.5, 1), halign="right"))
        ...
        data_title = Label(
            text="[b]📊 实时监测数据[/b]", markup=True, font_size=sp(15), color=(0.1, 0.1, 0.1, 1),
            size_hint_y=None, height=dp(30), halign="left", valign="middle"
        )
        ...
        self.flow_label = Label(
            text="主管路流量：-- m³/h", font_size=sp(13), color=(0.2, 0.2, 0.2, 1),
            size_hint_y=None, height=dp(30), halign="left", valign="middle"
        )
        ...
        self.press_main_label = Label(
            text="主管路压力：-- MPa", font_size=sp(13), color=(0.2, 0.2, 0.2, 1),
            size_hint_y=None, height=dp(30), halign="left", valign="middle"
        )
        ...
        self.press_valve_label = Label(
            text="调节阀压力：-- MPa", font_size=sp(13), color=(0.2, 0.2, 0.2, 1),
            size_hint_y=None, height=dp(30), halign="left", valign="middle"
        )
